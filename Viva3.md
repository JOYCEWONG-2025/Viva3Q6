...
public class TOSTest {
    ...
    public static void main(String[] args) {
        ...
        Hero[] heroes = {
            molly, sean, duncan, nathaniel, endor,
            urd, skuld, verthandi, idun, valkyrie,
            poseidon, hephaestus, athena, apollo, artemis
        };
...
//
//            Villain villain = villains[rand.nextInt(villains.length)];
//            
